...
```{r comparison-maps, fig.width=10, fig.height=7, fig.alt="Side-by-side maps showing true suitability, maxentcpp prediction, maxnet prediction, and the difference between maxentcpp and maxnet."}
par(mfrow = c(2, 2))
plot(true_rast,
...
```{r response-curves, fig.width=10, fig.height=5, fig.alt="Response curves showing predicted suitability as a function of bio1 and bio12 for the virtual species."}
par(mfrow = c(1, 2))
