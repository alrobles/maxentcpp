...
![Predicted habitat suitability map for Abeillia
abeillei.](reference/figures/README-project-1.png)
...
For a complete analysis in a single call, use
...
- [maxnet](https://CRAN.R-project.org/package=maxnet) — R implementation
  using glmnet
- [dismo](https://CRAN.R-project.org/package=dismo) — interface to Java
  Maxent from R
